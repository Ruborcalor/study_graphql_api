...
> = {
  studyTime?: Resolver<
    Maybe<ResolversTypes['StudyTime']>,
    ParentType,
    ContextType
  >
  leaderboardPlacement?: Resolver<
    Maybe<ResolversTypes['LeaderboardPlacement']>,
    ParentType,
    ContextType
  >
  studyRole?: Resolver<
    Maybe<ResolversTypes['StudyRole']>,
    ParentType,
    ContextType
  >
  pastDayTimeSeries?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['TimePoint']>>>,
    ParentType,
    ContextType
  >
  pastWeekTimeSeries?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['TimePoint']>>>,
    ParentType,
    ContextType
  >
  pastMonthTimeSeries?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['TimePoint']>>>,
    ParentType,
    ContextType
  >
  allTimeTimeSeries?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['TimePoint']>>>,
    ParentType,
    ContextType
  >
...
export type StudyTimeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['StudyTime'] = ResolversParentTypes['StudyTime']
> = {
...
export type LeaderboardPlacementResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['LeaderboardPlacement'] = ResolversParentTypes['LeaderboardPlacement']
> = {
...
export type StudyRoleResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['StudyRole'] = ResolversParentTypes['StudyRole']
> = {
  currentStudyRole?: Resolver<
    Maybe<ResolversTypes['String']>,
    ParentType,
    ContextType
  >
  nextStudyRole?: Resolver<
    Maybe<ResolversTypes['String']>,
    ParentType,
    ContextType
  >
  studyTimeToPromotion?: Resolver<
...
export type TimePointResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['TimePoint'] = ResolversParentTypes['TimePoint']
> = {
